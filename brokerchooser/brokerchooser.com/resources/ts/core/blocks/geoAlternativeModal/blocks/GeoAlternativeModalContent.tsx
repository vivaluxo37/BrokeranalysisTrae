...
export const GeoAlternativeModalContent: FC<GeoAlternativeModalData> = ({
    ...
    return (
        <div className="flex flex-col items-center gap-4 p-4 sm:p-6">
            <h1
                className="title-3 mx-10 text-center"
                data-testid="geo-alternative-modal-title"
            >
                {t(
            ...
            <div className="flex flex-col items-center gap-0.5 text-center">
                <div className="font-semibold">
                    ...
                    <Trans i18nKey="Best alternative for you: <1>[alternativeBrokerName]</1>" values={{ alternativeBrokerName: alternativeBroker.name }}>
                        Best alternative for you: <VisitBrokerLink broker={alternativeBroker} measurementListId="geo alternative modal visit alternative name link in description" measurementContext={ctaContext} className={visitBrokerLinkClassName} testId="alternative-broker-name-link-in-description">{alternativeBroker.name}</VisitBrokerLink>
                    </Trans>
                </div>
                <div>
                    {t(
                ...
                <div className="flex flex-col items-center">
                    <div className="flex items-center justify-center gap-4">
                        ...
                        <VisitBrokerLink
                            ...
                            testId="alternative-broker-logo-link"
                        >
                            <BrokerLogo
                                broker={alternativeBroker}
                    ...
                    <VisitBrokerLink
                        ...
                        testId="visit-alternative-name-link"
                    >
