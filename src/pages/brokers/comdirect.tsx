...
const ComdirectReview: React.FC = () => {
  const brokerData = {
    name: 'Comdirect',
    rating: 4.3,
    reviewCount: 2542,
    ...
    description: `Comdirect is a leading online broker offering comprehensive trading services across multiple asset classes. With competitive pricing and advanced trading tools, Comdirect serves traders and investors worldwide in 2025.`
  };
  ...
  return (
    <>
      <Helmet>
        ...
        <meta 
          name="description" 
          content={`Comprehensive Comdirect review 2025. Expert analysis of fees, platforms, regulation, and trading features. Read our detailed Comdirect broker review.`} 
        />
        <meta name="keywords" content={`Comdirect review 2025, Comdirect broker, Comdirect trading, online broker review, Comdirect fees`} />
        <link rel="canonical" href={`https://brokeranalysis.com/brokers/comdirect`} />
        
        {/* Open Graph */}
        <meta property="og:title" content={`Comdirect Review 2025 - Expert Broker Analysis`} />
        <meta property="og:description" content={`Detailed Comdirect review covering fees, platforms, regulation, and trading features. Updated for 2025.`} />
        <meta property="og:type" content="article" />
        <meta property="og:url" content={`https://brokeranalysis.com/brokers/comdirect`} />
        
        {/* Twitter Card */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content={`Comdirect Review 2025`} />
        <meta name="twitter:description" content={`Expert analysis of Comdirect broker - fees, platforms, and features for 2025.`} />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "reviewBody": "Comprehensive review of Comdirect covering all aspects of their trading services, fees, and platform features."
          })}
        </script>
      </Helmet>
...
export default ComdirectReview;
