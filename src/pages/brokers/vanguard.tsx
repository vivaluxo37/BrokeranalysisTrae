...
const VanguardReview: React.FC = () => {
  const brokerData = {
    ...
    description: `Vanguard is a leading online broker offering comprehensive trading services across multiple asset classes. With competitive pricing and advanced trading tools, Vanguard serves traders and investors worldwide in 2025.`
  };
  ...
  return (
    <>
      <Helmet>
        ...
        <meta 
          name="description" 
          content={`Comprehensive Vanguard review 2025. Expert analysis of fees, platforms, regulation, and trading features. Read our detailed Vanguard broker review.`} 
        />
        <meta name="keywords" content={`Vanguard review 2025, Vanguard broker, Vanguard trading, online broker review, Vanguard fees`} />
        <link rel="canonical" href={`https://brokeranalysis.com/brokers/vanguard`} />
        
        {/* Open Graph */}
        <meta property="og:title" content={`Vanguard Review 2025 - Expert Broker Analysis`} />
        <meta property="og:description" content={`Detailed Vanguard review covering fees, platforms, regulation, and trading features. Updated for 2025.`} />
        <meta property="og:type" content="article" />
        <meta property="og:url" content={`https://brokeranalysis.com/brokers/vanguard`} />
        
        {/* Twitter Card */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content={`Vanguard Review 2025`} />
        <meta name="twitter:description" content={`Expert analysis of Vanguard broker - fees, platforms, and features for 2025.`} />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "reviewBody": "Comprehensive review of Vanguard covering all aspects of their trading services, fees, and platform features."
          })}
        </script>
      </Helmet>
