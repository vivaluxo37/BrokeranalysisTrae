...
const FXTMReview: React.FC = () => {
  const brokerData = {
    ...
    description: `FXTM is a leading online broker offering comprehensive trading services across multiple asset classes. With competitive pricing and advanced trading tools, FXTM serves traders and investors worldwide in 2025.`
  };
  ...
  return (
    <>
      <Helmet>
        ...
        <meta 
          name="description" 
          content={`Comprehensive FXTM review 2025. Expert analysis of fees, platforms, regulation, and trading features. Read our detailed FXTM broker review.`} 
        />
        <meta name="keywords" content={`FXTM review 2025, FXTM broker, FXTM trading, online broker review, FXTM fees`} />
        <link rel="canonical" href={`https://brokeranalysis.com/brokers/fxtm`} />
        
        {/* Open Graph */}
        <meta property="og:title" content={`FXTM Review 2025 - Expert Broker Analysis`} />
        <meta property="og:description" content={`Detailed FXTM review covering fees, platforms, regulation, and trading features. Updated for 2025.`} />
        <meta property="og:type" content="article" />
        <meta property="og:url" content={`https://brokeranalysis.com/brokers/fxtm`} />
        
        {/* Twitter Card */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content={`FXTM Review 2025`} />
        <meta name="twitter:description" content={`Expert analysis of FXTM broker - fees, platforms, and features for 2025.`} />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "reviewBody": "Comprehensive review of FXTM covering all aspects of their trading services, fees, and platform features."
          })}
        </script>
      </Helmet>
