...
const FreetradeReview: React.FC = () => {
  const brokerData = {
    name: 'Freetrade',
    rating: 5,
    reviewCount: 4682,
    ...
    description: `Freetrade is a leading online broker offering comprehensive trading services across multiple asset classes. With competitive pricing and advanced trading tools, Freetrade serves traders and investors worldwide in 2025.`
  };
  ...
  return (
    <>
      <Helmet>
        ...
        <meta 
          name="description" 
          content={`Comprehensive Freetrade review 2025. Expert analysis of fees, platforms, regulation, and trading features. Read our detailed Freetrade broker review.`} 
        />
        <meta name="keywords" content={`Freetrade review 2025, Freetrade broker, Freetrade trading, online broker review, Freetrade fees`} />
        <link rel="canonical" href={`https://brokeranalysis.com/brokers/freetrade`} />
        
        {/* Open Graph */}
        <meta property="og:title" content={`Freetrade Review 2025 - Expert Broker Analysis`} />
        <meta property="og:description" content={`Detailed Freetrade review covering fees, platforms, regulation, and trading features. Updated for 2025.`} />
        <meta property="og:type" content="article" />
        <meta property="og:url" content={`https://brokeranalysis.com/brokers/freetrade`} />
        
        {/* Twitter Card */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content={`Freetrade Review 2025`} />
        <meta name="twitter:description" content={`Expert analysis of Freetrade broker - fees, platforms, and features for 2025.`} />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "reviewBody": "Comprehensive review of Freetrade covering all aspects of their trading services, fees, and platform features."
          })}
        </script>
      </Helmet>
...
export default FreetradeReview;
