...
const LightyearReview: React.FC = () => {
  const brokerData = {
    name: 'Lightyear',
    rating: 3.7,
    reviewCount: 2350,
    ...
    description: `Lightyear is a leading online broker offering comprehensive trading services across multiple asset classes. With competitive pricing and advanced trading tools, Lightyear serves traders and investors worldwide in 2025.`
  };
  ...
  return (
    <>
      <Helmet>
        ...
        <meta 
          name="description" 
          content={`Comprehensive Lightyear review 2025. Expert analysis of fees, platforms, regulation, and trading features. Read our detailed Lightyear broker review.`} 
        />
        <meta name="keywords" content={`Lightyear review 2025, Lightyear broker, Lightyear trading, online broker review, Lightyear fees`} />
        <link rel="canonical" href={`https://brokeranalysis.com/brokers/lightyear`} />
        
        {/* Open Graph */}
        <meta property="og:title" content={`Lightyear Review 2025 - Expert Broker Analysis`} />
        <meta property="og:description" content={`Detailed Lightyear review covering fees, platforms, regulation, and trading features. Updated for 2025.`} />
        <meta property="og:type" content="article" />
        <meta property="og:url" content={`https://brokeranalysis.com/brokers/lightyear`} />
        
        {/* Twitter Card */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content={`Lightyear Review 2025`} />
        <meta name="twitter:description" content={`Expert analysis of Lightyear broker - fees, platforms, and features for 2025.`} />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "reviewBody": "Comprehensive review of Lightyear covering all aspects of their trading services, fees, and platform features."
          })}
        </script>
      </Helmet>
...
export default LightyearReview;
