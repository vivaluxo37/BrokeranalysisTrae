...
const CapitalcomReview: React.FC = () => {
  const brokerData = {
    name: 'Capital.com',
    rating: 3.7,
    reviewCount: 2143,
    ...
    description: `Capital.com is a leading online broker offering comprehensive trading services across multiple asset classes. With competitive pricing and advanced trading tools, Capital.com serves traders and investors worldwide in 2025.`
  };
  ...
  return (
    <>
      <Helmet>
        ...
        <meta 
          name="description" 
          content={`Comprehensive Capital.com review 2025. Expert analysis of fees, platforms, regulation, and trading features. Read our detailed Capital.com broker review.`} 
        />
        <meta name="keywords" content={`Capital.com review 2025, Capital.com broker, Capital.com trading, online broker review, Capital.com fees`} />
        <link rel="canonical" href={`https://brokeranalysis.com/brokers/capitalcom`} />
        
        {/* Open Graph */}
        <meta property="og:title" content={`Capital.com Review 2025 - Expert Broker Analysis`} />
        <meta property="og:description" content={`Detailed Capital.com review covering fees, platforms, regulation, and trading features. Updated for 2025.`} />
        <meta property="og:type" content="article" />
        <meta property="og:url" content={`https://brokeranalysis.com/brokers/capitalcom`} />
        
        {/* Twitter Card */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content={`Capital.com Review 2025`} />
        <meta name="twitter:description" content={`Expert analysis of Capital.com broker - fees, platforms, and features for 2025.`} />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "reviewBody": "Comprehensive review of Capital.com covering all aspects of their trading services, fees, and platform features."
          })}
        </script>
      </Helmet>
...
export default CapitalcomReview;
