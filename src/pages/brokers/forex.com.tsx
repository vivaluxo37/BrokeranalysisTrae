...
const ForexcomReview: React.FC = () => {
  const brokerData = {
    ...
    description: `Forex.com is a leading online broker offering comprehensive trading services across multiple asset classes. With competitive pricing and advanced trading tools, Forex.com serves traders and investors worldwide in 2025.`
  };
  ...
  return (
    <>
      <Helmet>
        ...
        <meta 
          name="description" 
          content={`Comprehensive Forex.com review 2025. Expert analysis of fees, platforms, regulation, and trading features. Read our detailed Forex.com broker review.`} 
        />
        <meta name="keywords" content={`Forex.com review 2025, Forex.com broker, Forex.com trading, online broker review, Forex.com fees`} />
        <link rel="canonical" href={`https://brokeranalysis.com/brokers/forex.com`} />
        
        {/* Open Graph */}
        <meta property="og:title" content={`Forex.com Review 2025 - Expert Broker Analysis`} />
        <meta property="og:description" content={`Detailed Forex.com review covering fees, platforms, regulation, and trading features. Updated for 2025.`} />
        <meta property="og:type" content="article" />
        <meta property="og:url" content={`https://brokeranalysis.com/brokers/forex.com`} />
        
        {/* Twitter Card */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content={`Forex.com Review 2025`} />
        <meta name="twitter:description" content={`Expert analysis of Forex.com broker - fees, platforms, and features for 2025.`} />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "reviewBody": "Comprehensive review of Forex.com covering all aspects of their trading services, fees, and platform features."
          })}
        </script>
      </Helmet>
