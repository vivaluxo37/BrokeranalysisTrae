...
const XMReview: React.FC = () => {
  const brokerData = {
    ...
    description: `XM is a leading online broker offering comprehensive trading services across multiple asset classes. With competitive pricing and advanced trading tools, XM serves traders and investors worldwide in 2025.`
  };
  ...
  return (
    <>
      <Helmet>
        ...
        <meta 
          name="description" 
          content={`Comprehensive XM review 2025. Expert analysis of fees, platforms, regulation, and trading features. Read our detailed XM broker review.`} 
        />
        <meta name="keywords" content={`XM review 2025, XM broker, XM trading, online broker review, XM fees`} />
        <link rel="canonical" href={`https://brokeranalysis.com/brokers/xm`} />
        
        {/* Open Graph */}
        <meta property="og:title" content={`XM Review 2025 - Expert Broker Analysis`} />
        <meta property="og:description" content={`Detailed XM review covering fees, platforms, regulation, and trading features. Updated for 2025.`} />
        <meta property="og:type" content="article" />
        <meta property="og:url" content={`https://brokeranalysis.com/brokers/xm`} />
        
        {/* Twitter Card */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content={`XM Review 2025`} />
        <meta name="twitter:description" content={`Expert analysis of XM broker - fees, platforms, and features for 2025.`} />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "reviewBody": "Comprehensive review of XM covering all aspects of their trading services, fees, and platform features."
          })}
        </script>
      </Helmet>
