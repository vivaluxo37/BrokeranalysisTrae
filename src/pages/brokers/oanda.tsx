...
const OANDAReview: React.FC = () => {
  const brokerData = {
    ...
    description: `OANDA is a leading online broker offering comprehensive trading services across multiple asset classes. With competitive pricing and advanced trading tools, OANDA serves traders and investors worldwide in 2025.`
  };
  ...
  return (
    <>
      <Helmet>
        ...
        <meta 
          name="description" 
          content={`Comprehensive OANDA review 2025. Expert analysis of fees, platforms, regulation, and trading features. Read our detailed OANDA broker review.`} 
        />
        <meta name="keywords" content={`OANDA review 2025, OANDA broker, OANDA trading, online broker review, OANDA fees`} />
        <link rel="canonical" href={`https://brokeranalysis.com/brokers/oanda`} />
        
        {/* Open Graph */}
        <meta property="og:title" content={`OANDA Review 2025 - Expert Broker Analysis`} />
        <meta property="og:description" content={`Detailed OANDA review covering fees, platforms, regulation, and trading features. Updated for 2025.`} />
        <meta property="og:type" content="article" />
        <meta property="og:url" content={`https://brokeranalysis.com/brokers/oanda`} />
        
        {/* Twitter Card */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content={`OANDA Review 2025`} />
        <meta name="twitter:description" content={`Expert analysis of OANDA broker - fees, platforms, and features for 2025.`} />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "reviewBody": "Comprehensive review of OANDA covering all aspects of their trading services, fees, and platform features."
          })}
        </script>
      </Helmet>
