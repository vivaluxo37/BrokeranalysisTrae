...
const DavySelectReview: React.FC = () => {
  const brokerData = {
    name: 'Davy Select',
    rating: 4.4,
    reviewCount: 4301,
    ...
    description: `Davy Select is a leading online broker offering comprehensive trading services across multiple asset classes. With competitive pricing and advanced trading tools, Davy Select serves traders and investors worldwide in 2025.`
  };
  ...
  return (
    <>
      <Helmet>
        ...
        <meta 
          name="description" 
          content={`Comprehensive Davy Select review 2025. Expert analysis of fees, platforms, regulation, and trading features. Read our detailed Davy Select broker review.`} 
        />
        <meta name="keywords" content={`Davy Select review 2025, Davy Select broker, Davy Select trading, online broker review, Davy Select fees`} />
        <link rel="canonical" href={`https://brokeranalysis.com/brokers/davy-select`} />
        
        {/* Open Graph */}
        <meta property="og:title" content={`Davy Select Review 2025 - Expert Broker Analysis`} />
        <meta property="og:description" content={`Detailed Davy Select review covering fees, platforms, regulation, and trading features. Updated for 2025.`} />
        <meta property="og:type" content="article" />
        <meta property="og:url" content={`https://brokeranalysis.com/brokers/davy-select`} />
        
        {/* Twitter Card */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content={`Davy Select Review 2025`} />
        <meta name="twitter:description" content={`Expert analysis of Davy Select broker - fees, platforms, and features for 2025.`} />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "reviewBody": "Comprehensive review of Davy Select covering all aspects of their trading services, fees, and platform features."
          })}
        </script>
      </Helmet>
...
export default DavySelectReview;
