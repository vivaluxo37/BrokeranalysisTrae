...
const FBSReview: React.FC = () => {
  const brokerData = {
    ...
    description: `FBS is a leading online broker offering comprehensive trading services across multiple asset classes. With competitive pricing and advanced trading tools, FBS serves traders and investors worldwide in 2025.`
  };
  ...
  return (
    <>
      <Helmet>
        ...
        <meta 
          name="description" 
          content={`Comprehensive FBS review 2025. Expert analysis of fees, platforms, regulation, and trading features. Read our detailed FBS broker review.`} 
        />
        <meta name="keywords" content={`FBS review 2025, FBS broker, FBS trading, online broker review, FBS fees`} />
        <link rel="canonical" href={`https://brokeranalysis.com/brokers/fbs`} />
        
        {/* Open Graph */}
        <meta property="og:title" content={`FBS Review 2025 - Expert Broker Analysis`} />
        <meta property="og:description" content={`Detailed FBS review covering fees, platforms, regulation, and trading features. Updated for 2025.`} />
        <meta property="og:type" content="article" />
        <meta property="og:url" content={`https://brokeranalysis.com/brokers/fbs`} />
        
        {/* Twitter Card */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content={`FBS Review 2025`} />
        <meta name="twitter:description" content={`Expert analysis of FBS broker - fees, platforms, and features for 2025.`} />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "reviewBody": "Comprehensive review of FBS covering all aspects of their trading services, fees, and platform features."
          })}
        </script>
      </Helmet>
