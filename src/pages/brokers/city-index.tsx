...
const CityIndexReview: React.FC = () => {
  const brokerData = {
    name: 'City Index',
    rating: 4.2,
    reviewCount: 3140,
    ...
    description: `City Index is a leading online broker offering comprehensive trading services across multiple asset classes. With competitive pricing and advanced trading tools, City Index serves traders and investors worldwide in 2025.`
  };
  ...
  return (
    <>
      <Helmet>
        ...
        <meta 
          name="description" 
          content={`Comprehensive City Index review 2025. Expert analysis of fees, platforms, regulation, and trading features. Read our detailed City Index broker review.`} 
        />
        <meta name="keywords" content={`City Index review 2025, City Index broker, City Index trading, online broker review, City Index fees`} />
        <link rel="canonical" href={`https://brokeranalysis.com/brokers/city-index`} />
        
        {/* Open Graph */}
        <meta property="og:title" content={`City Index Review 2025 - Expert Broker Analysis`} />
        <meta property="og:description" content={`Detailed City Index review covering fees, platforms, regulation, and trading features. Updated for 2025.`} />
        <meta property="og:type" content="article" />
        <meta property="og:url" content={`https://brokeranalysis.com/brokers/city-index`} />
        
        {/* Twitter Card */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content={`City Index Review 2025`} />
        <meta name="twitter:description" content={`Expert analysis of City Index broker - fees, platforms, and features for 2025.`} />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "reviewBody": "Comprehensive review of City Index covering all aspects of their trading services, fees, and platform features."
          })}
        </script>
      </Helmet>
...
export default CityIndexReview;
