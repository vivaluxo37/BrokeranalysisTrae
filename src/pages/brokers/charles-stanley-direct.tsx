...
const CharlesStanleyDirectReview: React.FC = () => {
  const brokerData = {
    ...
    description: `Charles Stanley Direct is a leading online broker offering comprehensive trading services across multiple asset classes. With competitive pricing and advanced trading tools, Charles Stanley Direct serves traders and investors worldwide in 2025.`
  };
  ...
  return (
    <>
      <Helmet>
        ...
        <meta 
          name="description" 
          content={`Comprehensive Charles Stanley Direct review 2025. Expert analysis of fees, platforms, regulation, and trading features. Read our detailed Charles Stanley Direct broker review.`} 
        />
        <meta name="keywords" content={`Charles Stanley Direct review 2025, Charles Stanley Direct broker, Charles Stanley Direct trading, online broker review, Charles Stanley Direct fees`} />
        <link rel="canonical" href={`https://brokeranalysis.com/brokers/charles-stanley-direct`} />
        
        {/* Open Graph */}
        <meta property="og:title" content={`Charles Stanley Direct Review 2025 - Expert Broker Analysis`} />
        <meta property="og:description" content={`Detailed Charles Stanley Direct review covering fees, platforms, regulation, and trading features. Updated for 2025.`} />
        <meta property="og:type" content="article" />
        <meta property="og:url" content={`https://brokeranalysis.com/brokers/charles-stanley-direct`} />
        
        {/* Twitter Card */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content={`Charles Stanley Direct Review 2025`} />
        <meta name="twitter:description" content={`Expert analysis of Charles Stanley Direct broker - fees, platforms, and features for 2025.`} />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "reviewBody": "Comprehensive review of Charles Stanley Direct covering all aspects of their trading services, fees, and platform features."
          })}
        </script>
      </Helmet>
...
export default CharlesStanleyDirectReview;
