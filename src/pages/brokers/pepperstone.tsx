...
const PepperstoneReview: React.FC = () => {
  const brokerData = {
    ...
    description: `Pepperstone is a leading online broker offering comprehensive trading services across multiple asset classes. With competitive pricing and advanced trading tools, Pepperstone serves traders and investors worldwide in 2025.`
  };
  ...
  return (
    <>
      <Helmet>
        ...
        <meta 
          name="description" 
          content={`Comprehensive Pepperstone review 2025. Expert analysis of fees, platforms, regulation, and trading features. Read our detailed Pepperstone broker review.`} 
        />
        <meta name="keywords" content={`Pepperstone review 2025, Pepperstone broker, Pepperstone trading, online broker review, Pepperstone fees`} />
        <link rel="canonical" href={`https://brokeranalysis.com/brokers/pepperstone`} />
        
        {/* Open Graph */}
        <meta property="og:title" content={`Pepperstone Review 2025 - Expert Broker Analysis`} />
        <meta property="og:description" content={`Detailed Pepperstone review covering fees, platforms, regulation, and trading features. Updated for 2025.`} />
        <meta property="og:type" content="article" />
        <meta property="og:url" content={`https://brokeranalysis.com/brokers/pepperstone`} />
        
        {/* Twitter Card */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content={`Pepperstone Review 2025`} />
        <meta name="twitter:description" content={`Expert analysis of Pepperstone broker - fees, platforms, and features for 2025.`} />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "reviewBody": "Comprehensive review of Pepperstone covering all aspects of their trading services, fees, and platform features."
          })}
        </script>
      </Helmet>
