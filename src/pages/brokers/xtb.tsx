...
const XTBReview: React.FC = () => {
  const brokerData = {
    ...
    description: `XTB is a leading online broker offering comprehensive trading services across multiple asset classes. With competitive pricing and advanced trading tools, XTB serves traders and investors worldwide in 2025.`
  };
  ...
  return (
    <>
      <Helmet>
        ...
        <meta 
          name="description" 
          content={`Comprehensive XTB review 2025. Expert analysis of fees, platforms, regulation, and trading features. Read our detailed XTB broker review.`} 
        />
        <meta name="keywords" content={`XTB review 2025, XTB broker, XTB trading, online broker review, XTB fees`} />
        <link rel="canonical" href={`https://brokeranalysis.com/brokers/xtb`} />
        
        {/* Open Graph */}
        <meta property="og:title" content={`XTB Review 2025 - Expert Broker Analysis`} />
        <meta property="og:description" content={`Detailed XTB review covering fees, platforms, regulation, and trading features. Updated for 2025.`} />
        <meta property="og:type" content="article" />
        <meta property="og:url" content={`https://brokeranalysis.com/brokers/xtb`} />
        
        {/* Twitter Card */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content={`XTB Review 2025`} />
        <meta name="twitter:description" content={`Expert analysis of XTB broker - fees, platforms, and features for 2025.`} />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "reviewBody": "Comprehensive review of XTB covering all aspects of their trading services, fees, and platform features."
          })}
        </script>
      </Helmet>
