...
const AJBellYouInvestReview: React.FC = () => {
  const brokerData = {
    ...
    platforms: ["Web Platform","Mobile App","Desktop App"],
    description: `AJ Bell YouInvest is a leading online broker offering comprehensive trading services across multiple asset classes. With competitive pricing and advanced trading tools, AJ Bell YouInvest serves traders and investors worldwide in 2025.`
  };
  ...
  return (
    <>
      <Helmet>
        ...
        <meta 
          name="description" 
          content={`Comprehensive AJ Bell YouInvest review 2025. Expert analysis of fees, platforms, regulation, and trading features. Read our detailed AJ Bell YouInvest broker review.`} 
        />
        <meta name="keywords" content={`AJ Bell YouInvest review 2025, AJ Bell YouInvest broker, AJ Bell YouInvest trading, online broker review, AJ Bell YouInvest fees`} />
        <link rel="canonical" href={`https://brokeranalysis.com/brokers/aj-bell-youinvest`} />
        
        {/* Open Graph */}
        <meta property="og:title" content={`AJ Bell YouInvest Review 2025 - Expert Broker Analysis`} />
        <meta property="og:description" content={`Detailed AJ Bell YouInvest review covering fees, platforms, regulation, and trading features. Updated for 2025.`} />
        <meta property="og:type" content="article" />
        <meta property="og:url" content={`https://brokeranalysis.com/brokers/aj-bell-youinvest`} />
        
        {/* Twitter Card */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content={`AJ Bell YouInvest Review 2025`} />
        <meta name="twitter:description" content={`Expert analysis of AJ Bell YouInvest broker - fees, platforms, and features for 2025.`} />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "reviewBody": "Comprehensive review of AJ Bell YouInvest covering all aspects of their trading services, fees, and platform features."
          })}
        </script>
      </Helmet>
...
export default AJBellYouInvestReview;
