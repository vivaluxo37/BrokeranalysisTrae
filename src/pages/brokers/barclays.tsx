...
const BarclaysReview: React.FC = () => {
  const brokerData = {
    ...
    description: `Barclays is a leading online broker offering comprehensive trading services across multiple asset classes. With competitive pricing and advanced trading tools, Barclays serves traders and investors worldwide in 2025.`
  };
  ...
  return (
    <>
      <Helmet>
        ...
        <meta 
          name="description" 
          content={`Comprehensive Barclays review 2025. Expert analysis of fees, platforms, regulation, and trading features. Read our detailed Barclays broker review.`} 
        />
        <meta name="keywords" content={`Barclays review 2025, Barclays broker, Barclays trading, online broker review, Barclays fees`} />
        <link rel="canonical" href={`https://brokeranalysis.com/brokers/barclays`} />
        
        {/* Open Graph */}
        <meta property="og:title" content={`Barclays Review 2025 - Expert Broker Analysis`} />
        <meta property="og:description" content={`Detailed Barclays review covering fees, platforms, regulation, and trading features. Updated for 2025.`} />
        <meta property="og:type" content="article" />
        <meta property="og:url" content={`https://brokeranalysis.com/brokers/barclays`} />
        
        {/* Twitter Card */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content={`Barclays Review 2025`} />
        <meta name="twitter:description" content={`Expert analysis of Barclays broker - fees, platforms, and features for 2025.`} />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "reviewBody": "Comprehensive review of Barclays covering all aspects of their trading services, fees, and platform features."
          })}
        </script>
      </Helmet>
