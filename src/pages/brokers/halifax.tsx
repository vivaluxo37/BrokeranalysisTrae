...
const HalifaxReview: React.FC = () => {
  const brokerData = {
    ...
    description: `Halifax is a leading online broker offering comprehensive trading services across multiple asset classes. With competitive pricing and advanced trading tools, Halifax serves traders and investors worldwide in 2025.`
  };
  ...
  return (
    <>
      <Helmet>
        ...
        <meta 
          name="description" 
          content={`Comprehensive Halifax review 2025. Expert analysis of fees, platforms, regulation, and trading features. Read our detailed Halifax broker review.`} 
        />
        <meta name="keywords" content={`Halifax review 2025, Halifax broker, Halifax trading, online broker review, Halifax fees`} />
        <link rel="canonical" href={`https://brokeranalysis.com/brokers/halifax`} />
        
        {/* Open Graph */}
        <meta property="og:title" content={`Halifax Review 2025 - Expert Broker Analysis`} />
        <meta property="og:description" content={`Detailed Halifax review covering fees, platforms, regulation, and trading features. Updated for 2025.`} />
        <meta property="og:type" content="article" />
        <meta property="og:url" content={`https://brokeranalysis.com/brokers/halifax`} />
        
        {/* Twitter Card */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content={`Halifax Review 2025`} />
        <meta name="twitter:description" content={`Expert analysis of Halifax broker - fees, platforms, and features for 2025.`} />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "reviewBody": "Comprehensive review of Halifax covering all aspects of their trading services, fees, and platform features."
          })}
        </script>
      </Helmet>
