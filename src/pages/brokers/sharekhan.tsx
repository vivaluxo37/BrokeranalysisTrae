...
const SharekhanReview: React.FC = () => {
  const brokerData = {
    name: 'Sharekhan',
    rating: 4.4,
    reviewCount: 2705,
    ...
    description: `Sharekhan is a leading online broker offering comprehensive trading services across multiple asset classes. With competitive pricing and advanced trading tools, Sharekhan serves traders and investors worldwide in 2025.`
  };
  ...
  return (
    <>
      <Helmet>
        ...
        <meta 
          name="description" 
          content={`Comprehensive Sharekhan review 2025. Expert analysis of fees, platforms, regulation, and trading features. Read our detailed Sharekhan broker review.`} 
        />
        <meta name="keywords" content={`Sharekhan review 2025, Sharekhan broker, Sharekhan trading, online broker review, Sharekhan fees`} />
        <link rel="canonical" href={`https://brokeranalysis.com/brokers/sharekhan`} />
        
        {/* Open Graph */}
        <meta property="og:title" content={`Sharekhan Review 2025 - Expert Broker Analysis`} />
        <meta property="og:description" content={`Detailed Sharekhan review covering fees, platforms, regulation, and trading features. Updated for 2025.`} />
        <meta property="og:type" content="article" />
        <meta property="og:url" content={`https://brokeranalysis.com/brokers/sharekhan`} />
        
        {/* Twitter Card */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content={`Sharekhan Review 2025`} />
        <meta name="twitter:description" content={`Expert analysis of Sharekhan broker - fees, platforms, and features for 2025.`} />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "reviewBody": "Comprehensive review of Sharekhan covering all aspects of their trading services, fees, and platform features."
          })}
        </script>
      </Helmet>
...
export default SharekhanReview;
