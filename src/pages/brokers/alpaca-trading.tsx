...
const AlpacaTradingReview: React.FC = () => {
  const brokerData = {
    name: 'Alpaca Trading',
    rating: 3.1,
    reviewCount: 1506,
    ...
    description: `Alpaca Trading is a leading online broker offering comprehensive trading services across multiple asset classes. With competitive pricing and advanced trading tools, Alpaca Trading serves traders and investors worldwide in 2025.`
  };
  ...
  return (
    <>
      <Helmet>
        ...
        <meta 
          name="description" 
          content={`Comprehensive Alpaca Trading review 2025. Expert analysis of fees, platforms, regulation, and trading features. Read our detailed Alpaca Trading broker review.`} 
        />
        <meta name="keywords" content={`Alpaca Trading review 2025, Alpaca Trading broker, Alpaca Trading trading, online broker review, Alpaca Trading fees`} />
        <link rel="canonical" href={`https://brokeranalysis.com/brokers/alpaca-trading`} />
        
        {/* Open Graph */}
        <meta property="og:title" content={`Alpaca Trading Review 2025 - Expert Broker Analysis`} />
        <meta property="og:description" content={`Detailed Alpaca Trading review covering fees, platforms, regulation, and trading features. Updated for 2025.`} />
        <meta property="og:type" content="article" />
        <meta property="og:url" content={`https://brokeranalysis.com/brokers/alpaca-trading`} />
        
        {/* Twitter Card */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content={`Alpaca Trading Review 2025`} />
        <meta name="twitter:description" content={`Expert analysis of Alpaca Trading broker - fees, platforms, and features for 2025.`} />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "reviewBody": "Comprehensive review of Alpaca Trading covering all aspects of their trading services, fees, and platform features."
          })}
        </script>
      </Helmet>
...
export default AlpacaTradingReview;
