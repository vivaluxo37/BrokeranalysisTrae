...
const ZerodhaReview: React.FC = () => {
  const brokerData = {
    ...
    description: `Zerodha is a leading online broker offering comprehensive trading services across multiple asset classes. With competitive pricing and advanced trading tools, Zerodha serves traders and investors worldwide in 2025.`
  };
  ...
  return (
    <>
      <Helmet>
        ...
        <meta 
          name="description" 
          content={`Comprehensive Zerodha review 2025. Expert analysis of fees, platforms, regulation, and trading features. Read our detailed Zerodha broker review.`} 
        />
        <meta name="keywords" content={`Zerodha review 2025, Zerodha broker, Zerodha trading, online broker review, Zerodha fees`} />
        <link rel="canonical" href={`https://brokeranalysis.com/brokers/zerodha`} />
        
        {/* Open Graph */}
        <meta property="og:title" content={`Zerodha Review 2025 - Expert Broker Analysis`} />
        <meta property="og:description" content={`Detailed Zerodha review covering fees, platforms, regulation, and trading features. Updated for 2025.`} />
        <meta property="og:type" content="article" />
        <meta property="og:url" content={`https://brokeranalysis.com/brokers/zerodha`} />
        
        {/* Twitter Card */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content={`Zerodha Review 2025`} />
        <meta name="twitter:description" content={`Expert analysis of Zerodha broker - fees, platforms, and features for 2025.`} />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "reviewBody": "Comprehensive review of Zerodha covering all aspects of their trading services, fees, and platform features."
          })}
        </script>
      </Helmet>
