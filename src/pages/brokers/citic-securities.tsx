...
const CITICSecuritiesReview: React.FC = () => {
  const brokerData = {
    ...
    description: `CITIC Securities is a leading online broker offering comprehensive trading services across multiple asset classes. With competitive pricing and advanced trading tools, CITIC Securities serves traders and investors worldwide in 2025.`
  };
  ...
  return (
    <>
      <Helmet>
        ...
        <meta 
          name="description" 
          content={`Comprehensive CITIC Securities review 2025. Expert analysis of fees, platforms, regulation, and trading features. Read our detailed CITIC Securities broker review.`} 
        />
        <meta name="keywords" content={`CITIC Securities review 2025, CITIC Securities broker, CITIC Securities trading, online broker review, CITIC Securities fees`} />
        <link rel="canonical" href={`https://brokeranalysis.com/brokers/citic-securities`} />
        
        {/* Open Graph */}
        <meta property="og:title" content={`CITIC Securities Review 2025 - Expert Broker Analysis`} />
        <meta property="og:description" content={`Detailed CITIC Securities review covering fees, platforms, regulation, and trading features. Updated for 2025.`} />
        <meta property="og:type" content="article" />
        <meta property="og:url" content={`https://brokeranalysis.com/brokers/citic-securities`} />
        
        {/* Twitter Card */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content={`CITIC Securities Review 2025`} />
        <meta name="twitter:description" content={`Expert analysis of CITIC Securities broker - fees, platforms, and features for 2025.`} />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "reviewBody": "Comprehensive review of CITIC Securities covering all aspects of their trading services, fees, and platform features."
          })}
        </script>
      </Helmet>
...
export default CITICSecuritiesReview;
