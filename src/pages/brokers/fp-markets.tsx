...
const FPMarketsReview: React.FC = () => {
  const brokerData = {
    ...
    description: `FP Markets is a leading online broker offering comprehensive trading services across multiple asset classes. With competitive pricing and advanced trading tools, FP Markets serves traders and investors worldwide in 2025.`
  };
  ...
  return (
    <>
      <Helmet>
        ...
        <meta 
          name="description" 
          content={`Comprehensive FP Markets review 2025. Expert analysis of fees, platforms, regulation, and trading features. Read our detailed FP Markets broker review.`} 
        />
        <meta name="keywords" content={`FP Markets review 2025, FP Markets broker, FP Markets trading, online broker review, FP Markets fees`} />
        <link rel="canonical" href={`https://brokeranalysis.com/brokers/fp-markets`} />
        
        {/* Open Graph */}
        <meta property="og:title" content={`FP Markets Review 2025 - Expert Broker Analysis`} />
        <meta property="og:description" content={`Detailed FP Markets review covering fees, platforms, regulation, and trading features. Updated for 2025.`} />
        <meta property="og:type" content="article" />
        <meta property="og:url" content={`https://brokeranalysis.com/brokers/fp-markets`} />
        
        {/* Twitter Card */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content={`FP Markets Review 2025`} />
        <meta name="twitter:description" content={`Expert analysis of FP Markets broker - fees, platforms, and features for 2025.`} />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "reviewBody": "Comprehensive review of FP Markets covering all aspects of their trading services, fees, and platform features."
          })}
        </script>
      </Helmet>
