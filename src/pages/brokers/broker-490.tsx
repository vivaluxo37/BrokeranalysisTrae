              ...
              <div className="bg-white p-6 rounded-lg shadow-sm">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center">
                    ...
                    <a href="https://www.amarkets.com" target="_blank" rel="noopener noreferrer" className="text-sm text-blue-600 hover:underline">
                      Official Website
                    </a>
                  </div>
                </div>
