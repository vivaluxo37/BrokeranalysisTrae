...
const JPMorganSelfDirectedInvestingReview: React.FC = () => {
  const brokerData = {
    ...
    minDeposit: '$1,000',
    regulators: ["FCA"],
    assetClasses: ["Stocks","Forex","CFDs"],
    platforms: ["Web Platform","Mobile App"],
    description: `J.P. Morgan Self-Directed Investing is a leading online broker offering comprehensive trading services across multiple asset classes. With competitive pricing and advanced trading tools, J.P. Morgan Self-Directed Investing serves traders and investors worldwide in 2025.`
  };
  ...
  return (
    <>
      <Helmet>
        ...
        <meta 
          name="description" 
          content={`Comprehensive J.P. Morgan Self-Directed Investing review 2025. Expert analysis of fees, platforms, regulation, and trading features. Read our detailed J.P. Morgan Self-Directed Investing broker review.`} 
        />
        <meta name="keywords" content={`J.P. Morgan Self-Directed Investing review 2025, J.P. Morgan Self-Directed Investing broker, J.P. Morgan Self-Directed Investing trading, online broker review, J.P. Morgan Self-Directed Investing fees`} />
        <link rel="canonical" href={`https://brokeranalysis.com/brokers/jp-morgan-self-directed-investing`} />
        
        {/* Open Graph */}
        <meta property="og:title" content={`J.P. Morgan Self-Directed Investing Review 2025 - Expert Broker Analysis`} />
        <meta property="og:description" content={`Detailed J.P. Morgan Self-Directed Investing review covering fees, platforms, regulation, and trading features. Updated for 2025.`} />
        <meta property="og:type" content="article" />
        <meta property="og:url" content={`https://brokeranalysis.com/brokers/jp-morgan-self-directed-investing`} />
        
        {/* Twitter Card */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content={`J.P. Morgan Self-Directed Investing Review 2025`} />
        <meta name="twitter:description" content={`Expert analysis of J.P. Morgan Self-Directed Investing broker - fees, platforms, and features for 2025.`} />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "reviewBody": "Comprehensive review of J.P. Morgan Self-Directed Investing covering all aspects of their trading services, fees, and platform features."
          })}
        </script>
      </Helmet>
...
export default JPMorganSelfDirectedInvestingReview;
