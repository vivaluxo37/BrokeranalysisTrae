...
const HargreavesLansdownReview: React.FC = () => {
  const brokerData = {
    ...
    description: `Hargreaves Lansdown is a leading online broker offering comprehensive trading services across multiple asset classes. With competitive pricing and advanced trading tools, Hargreaves Lansdown serves traders and investors worldwide in 2025.`
  };
  ...
  return (
    <>
      <Helmet>
        ...
        <meta 
          name="description" 
          content={`Comprehensive Hargreaves Lansdown review 2025. Expert analysis of fees, platforms, regulation, and trading features. Read our detailed Hargreaves Lansdown broker review.`} 
        />
        <meta name="keywords" content={`Hargreaves Lansdown review 2025, Hargreaves Lansdown broker, Hargreaves Lansdown trading, online broker review, Hargreaves Lansdown fees`} />
        <link rel="canonical" href={`https://brokeranalysis.com/brokers/hargreaves-lansdown`} />
        
        {/* Open Graph */}
        <meta property="og:title" content={`Hargreaves Lansdown Review 2025 - Expert Broker Analysis`} />
        <meta property="og:description" content={`Detailed Hargreaves Lansdown review covering fees, platforms, regulation, and trading features. Updated for 2025.`} />
        <meta property="og:type" content="article" />
        <meta property="og:url" content={`https://brokeranalysis.com/brokers/hargreaves-lansdown`} />
        
        {/* Twitter Card */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content={`Hargreaves Lansdown Review 2025`} />
        <meta name="twitter:description" content={`Expert analysis of Hargreaves Lansdown broker - fees, platforms, and features for 2025.`} />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "reviewBody": "Comprehensive review of Hargreaves Lansdown covering all aspects of their trading services, fees, and platform features."
          })}
        </script>
      </Helmet>
...
export default HargreavesLansdownReview;
