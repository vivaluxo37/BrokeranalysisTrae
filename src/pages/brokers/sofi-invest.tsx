...
const SoFiInvestReview: React.FC = () => {
  const brokerData = {
    name: 'SoFi Invest',
    rating: 4.7,
    reviewCount: 1553,
    ...
    description: `SoFi Invest is a leading online broker offering comprehensive trading services across multiple asset classes. With competitive pricing and advanced trading tools, SoFi Invest serves traders and investors worldwide in 2025.`
  };
  ...
  return (
    <>
      <Helmet>
        ...
        <meta 
          name="description" 
          content={`Comprehensive SoFi Invest review 2025. Expert analysis of fees, platforms, regulation, and trading features. Read our detailed SoFi Invest broker review.`} 
        />
        <meta name="keywords" content={`SoFi Invest review 2025, SoFi Invest broker, SoFi Invest trading, online broker review, SoFi Invest fees`} />
        <link rel="canonical" href={`https://brokeranalysis.com/brokers/sofi-invest`} />
        
        {/* Open Graph */}
        <meta property="og:title" content={`SoFi Invest Review 2025 - Expert Broker Analysis`} />
        <meta property="og:description" content={`Detailed SoFi Invest review covering fees, platforms, regulation, and trading features. Updated for 2025.`} />
        <meta property="og:type" content="article" />
        <meta property="og:url" content={`https://brokeranalysis.com/brokers/sofi-invest`} />
        
        {/* Twitter Card */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content={`SoFi Invest Review 2025`} />
        <meta name="twitter:description" content={`Expert analysis of SoFi Invest broker - fees, platforms, and features for 2025.`} />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "reviewBody": "Comprehensive review of SoFi Invest covering all aspects of their trading services, fees, and platform features."
          })}
        </script>
      </Helmet>
...
export default SoFiInvestReview;
