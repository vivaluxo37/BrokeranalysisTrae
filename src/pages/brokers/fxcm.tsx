...
const FXCMReview: React.FC = () => {
  const brokerData = {
    ...
    description: `FXCM is a leading online broker offering comprehensive trading services across multiple asset classes. With competitive pricing and advanced trading tools, FXCM serves traders and investors worldwide in 2025.`
  };
  ...
  return (
    <>
      <Helmet>
        ...
        <meta 
          name="description" 
          content={`Comprehensive FXCM review 2025. Expert analysis of fees, platforms, regulation, and trading features. Read our detailed FXCM broker review.`} 
        />
        <meta name="keywords" content={`FXCM review 2025, FXCM broker, FXCM trading, online broker review, FXCM fees`} />
        <link rel="canonical" href={`https://brokeranalysis.com/brokers/fxcm`} />
        
        {/* Open Graph */}
        <meta property="og:title" content={`FXCM Review 2025 - Expert Broker Analysis`} />
        <meta property="og:description" content={`Detailed FXCM review covering fees, platforms, regulation, and trading features. Updated for 2025.`} />
        <meta property="og:type" content="article" />
        <meta property="og:url" content={`https://brokeranalysis.com/brokers/fxcm`} />
        
        {/* Twitter Card */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content={`FXCM Review 2025`} />
        <meta name="twitter:description" content={`Expert analysis of FXCM broker - fees, platforms, and features for 2025.`} />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "reviewBody": "Comprehensive review of FXCM covering all aspects of their trading services, fees, and platform features."
          })}
        </script>
      </Helmet>
