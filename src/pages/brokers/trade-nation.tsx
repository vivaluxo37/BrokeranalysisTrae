...
const TradeNationReview: React.FC = () => {
  const brokerData = {
    name: 'Trade Nation',
    rating: 4.3,
    reviewCount: 2327,
    ...
    description: `Trade Nation is a leading online broker offering comprehensive trading services across multiple asset classes. With competitive pricing and advanced trading tools, Trade Nation serves traders and investors worldwide in 2025.`
  };
  ...
  return (
    <>
      <Helmet>
        ...
        <meta 
          name="description" 
          content={`Comprehensive Trade Nation review 2025. Expert analysis of fees, platforms, regulation, and trading features. Read our detailed Trade Nation broker review.`} 
        />
        <meta name="keywords" content={`Trade Nation review 2025, Trade Nation broker, Trade Nation trading, online broker review, Trade Nation fees`} />
        <link rel="canonical" href={`https://brokeranalysis.com/brokers/trade-nation`} />
        
        {/* Open Graph */}
        <meta property="og:title" content={`Trade Nation Review 2025 - Expert Broker Analysis`} />
        <meta property="og:description" content={`Detailed Trade Nation review covering fees, platforms, regulation, and trading features. Updated for 2025.`} />
        <meta property="og:type" content="article" />
        <meta property="og:url" content={`https://brokeranalysis.com/brokers/trade-nation`} />
        
        {/* Twitter Card */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content={`Trade Nation Review 2025`} />
        <meta name="twitter:description" content={`Expert analysis of Trade Nation broker - fees, platforms, and features for 2025.`} />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "reviewBody": "Comprehensive review of Trade Nation covering all aspects of their trading services, fees, and platform features."
          })}
        </script>
      </Helmet>
...
export default TradeNationReview;
