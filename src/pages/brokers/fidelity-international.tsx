...
const FidelityInternationalReview: React.FC = () => {
  const brokerData = {
    ...
    assetClasses: ["Stocks","Forex","CFDs","Options"],
    platforms: ["Web Platform","Mobile App"],
    description: `Fidelity International is a leading online broker offering comprehensive trading services across multiple asset classes. With competitive pricing and advanced trading tools, Fidelity International serves traders and investors worldwide in 2025.`
  };
  ...
  return (
    <>
      <Helmet>
        ...
        <meta 
          name="description" 
          content={`Comprehensive Fidelity International review 2025. Expert analysis of fees, platforms, regulation, and trading features. Read our detailed Fidelity International broker review.`} 
        />
        <meta name="keywords" content={`Fidelity International review 2025, Fidelity International broker, Fidelity International trading, online broker review, Fidelity International fees`} />
        <link rel="canonical" href={`https://brokeranalysis.com/brokers/fidelity-international`} />
        
        {/* Open Graph */}
        <meta property="og:title" content={`Fidelity International Review 2025 - Expert Broker Analysis`} />
        <meta property="og:description" content={`Detailed Fidelity International review covering fees, platforms, regulation, and trading features. Updated for 2025.`} />
        <meta property="og:type" content="article" />
        <meta property="og:url" content={`https://brokeranalysis.com/brokers/fidelity-international`} />
        
        {/* Twitter Card */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content={`Fidelity International Review 2025`} />
        <meta name="twitter:description" content={`Expert analysis of Fidelity International broker - fees, platforms, and features for 2025.`} />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "reviewBody": "Comprehensive review of Fidelity International covering all aspects of their trading services, fees, and platform features."
          })}
        </script>
      </Helmet>
...
export default FidelityInternationalReview;
